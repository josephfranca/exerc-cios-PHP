...
function verificarCategoria($categoria){
    switch ($categoria){
        ...
        case "vestuário":
            ...
            break;
        case "alimentos":
            return "Essa categoria é de alimentos";
            break;
        default:
...
//Caso não seja nenhum dos cases da função
$entrada = "teste";

print(verificarCategoria($entrada));

//Poderia usar if encadeado mas switch case se encaixa perfeitamente nessa situação
